...
let data_atual = new Date(); // Date() é usado para trablhar com datas na linguagem JavaScript.
let numero_escolhido = data_atual.getDate(); // getDate() nos permite obter o dia do mes de uma data.

console.log("Número sorteado: "+numero_escolhido);

numero_escolhido--; // Como o primerio dia de um mês será 1 fazemos o decremento para corresponder os dias com os índices do array.

 frases_do_dia = frases_do_dia[numero_escolhido];

console.log("Frases do Dia");
